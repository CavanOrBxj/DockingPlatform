...
public class Test1313Sign {

	public static void main(String[] args) throws Exception {
		
		YingJGBCALLDLL.openDevice(1); // 打开sjj1313
        ...
        writeSign(xmlSign,"sign1313_3.txt");
